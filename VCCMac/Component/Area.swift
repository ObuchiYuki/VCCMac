...
final class Area: NSLoadView {
    ...
    override func onAwake() {
        ...
        self.iconView.image = R.Image.export
        ...
        self.titleLabel.font = NSFont.systemFont(ofSize: R.FontSize.controlTitle)
        
        self.titleStack.addArrangedSubview(messageLabel)
        self.messageLabel.isHidden = true
        self.messageLabel.font = NSFont.systemFont(ofSize: R.FontSize.control)
